...
test('cake reserve uses the shared compact calendar and a Cake-only availability contract', () => {
  ...
  assert.match(i18n, /Cake pick-up · Every day 08:00–20:00/)
  assert.match(i18n, /케이크 픽업 · 매일 08:00–20:00/)
...
test('AU customer source has no stale weekend-only pickup hours', () => {
  ...
  for (const stale of [
    ...
    'Cake pick-up is available Friday 18:00–20:00 and Saturday–Sunday 08:00–20:00.',
    '케이크 픽업 · 금 18:00–20:00 · 토·일 08:00–20:00',
    '케이크 픽업은 금요일 18:00–20:00, 토·일요일 08:00–20:00에 가능합니다.',
