...
export const MARKET_CONFIG: Record<Market, MarketConfig> = {
  ...
  AU: {
    ...
    productCardFeatures: {
      ...
      'brownie-cheesecake': [AU_CAKE_SIZE_LABELS['15cm'], 'Basic finish · AUD 55.00', 'Three finishing options'],
      ...
      'fresh-lemon-cupcakes-4': ['Made with freshly squeezed lemon juice', 'Fresh lemon cream', 'Floral decoration', 'Boxes of 6, 8, 12 or 16'],
      'fresh-lemon-cupcakes-6': ['Made with freshly squeezed lemon juice', 'Fresh lemon cream', 'Floral decoration', 'Boxes of 6, 8, 12 or 16'],
      'fresh-lemon-cupcakes-8': ['Made with freshly squeezed lemon juice', 'Fresh lemon cream', 'Floral decoration', 'Boxes of 6, 8, 12 or 16'],
      'fresh-lemon-cupcakes-12': ['Made with freshly squeezed lemon juice', 'Fresh lemon cream', 'Floral decoration', 'Boxes of 6, 8, 12 or 16'],
      'fresh-lemon-cupcakes-16': ['Made with freshly squeezed lemon juice', 'Fresh lemon cream', 'Floral decoration', 'Boxes of 6, 8, 12 or 16'],
    },
    guideSteps: [
