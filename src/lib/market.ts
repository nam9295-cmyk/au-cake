  ...
  AU: {
    ...
    products: {
      ...
      'vanilla-fresh-cream-cake': {
        ...
        description: 'Chocolate cake sheets layered with plain fresh cream for a clean, chocolate-forward cake without added fruit or flavoured fillings.',
        price: 69,
        priceNote: 'Choose a size · Plain fresh cream between chocolate cake sheets',
        usesCacaoOptions: false,
        usesSizeOptions: true,
        usesChocolateTypeOptions: false,
        usesPoundAddonOptions: false,
      ...
      'buttercream-cake': {
        ...
        description: 'Chocolate cake sheets layered and finished with Chocolate Buttercream. Choose a point colour to personalise the finish.',
        price: 74,
        priceNote: 'Choose a size and point colour · Chocolate Buttercream between chocolate cake sheets',
        usesCacaoOptions: false,
        usesSizeOptions: true,
        usesChocolateTypeOptions: false,
        usesPoundAddonOptions: false,
    ...
    productCardFeatures: {
      ...
      'vanilla-fresh-cream-cake': ['Chocolate cake sheets', 'Plain fresh cream between each layer', 'No added fruit or flavour', Object.values(AU_CAKE_SIZE_LABELS).join(' · ')],
      'buttercream-cake': ['Chocolate cake sheets', 'Chocolate Buttercream between each layer', 'Choose a point colour', Object.values(AU_CAKE_SIZE_LABELS).join(' · ')],
