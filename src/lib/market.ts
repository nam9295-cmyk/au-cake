  ...
  AU: {
    ...
    products: {
      ...
      'buttercream-cake': {
        ...
        description: 'Our Signature Gâteau au Chocolat layers are filled and finished with chocolate buttercream made with organic cocoa, fresh milk and chocolatier-grade couverture chocolate. The deep, intense chocolate taste comes from real cocoa and couverture—not added chocolate flavouring.',
        price: 74,
