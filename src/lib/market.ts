  ...
  AU: {
    ...
    products: {
      ...
      'cupcake-dozen': {
        ...
        price: 55,
        priceNote: 'AUD 10 more than pound cake, choose one finish option',
        usesCacaoOptions: false,
        usesSizeOptions: false,
        usesChocolateTypeOptions: false,
        usesPoundAddonOptions: true,
      ...
      'pave-choco-basque-cheesecake': {
        id: 'pave-choco-basque-cheesecake',
        name: 'Pave Chocolate Basque Cheesecake',
        description: 'Our 6 inch chocolate Basque cheesecake finished with a dense layer of pave chocolate.',
        price: 65,
        priceNote: '6 inch / 15cm fixed size',
        usesCacaoOptions: false,
        usesSizeOptions: false,
      ...
      'fresh-lemon-cupcakes-4': {
        id: 'fresh-lemon-cupcakes-4', name: 'Fresh Lemon Cupcakes · 4 cupcakes',
        description: 'Lemon-shaped cakes filled with fresh lemon cream and finished with a floral decoration.',
        price: 24, priceNote: '4 cupcakes · lemon cream and floral finish included',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-6': {
        id: 'fresh-lemon-cupcakes-6', name: 'Fresh Lemon Cupcakes · 6 cupcakes',
        description: 'Lemon-shaped cakes filled with fresh lemon cream and finished with a floral decoration.',
        price: 36, priceNote: '6 cupcakes · Most Popular',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-8': {
        id: 'fresh-lemon-cupcakes-8', name: 'Fresh Lemon Cupcakes · 8 cupcakes',
        description: 'Lemon-shaped cakes filled with fresh lemon cream and finished with a floral decoration.',
        price: 45, priceNote: '8 cupcakes · lemon cream and floral finish included',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-12': {
        id: 'fresh-lemon-cupcakes-12', name: 'Fresh Lemon Cupcakes · 12 cupcakes',
        description: 'Lemon-shaped cakes filled with fresh lemon cream and finished with a floral decoration.',
        price: 65, priceNote: '12 cupcakes · Best Value',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
    },
    cakeSizeOptions: [
    ...
    productCardFeatures: {
      ...
      'cupcake-dozen': ['12 cupcakes in one dozen', 'AUD 10 more than pound cake', 'Basic, extra chocolate, or vanilla cream finish'],
      'choco-basque-cheesecake': ['6 inch / 15cm fixed size', 'Deeply baked chocolate Basque cheesecake', 'Smooth, rich centre'],
      'pave-choco-basque-cheesecake': ['6 inch / 15cm fixed size', 'Pave chocolate finish', 'Our richer cheesecake option'],
      'fresh-lemon-cupcakes-4': ['4 cupcakes', 'Fresh lemon cream', 'Floral decoration included'],
      'fresh-lemon-cupcakes-6': ['6 cupcakes', 'Most Popular', 'Fresh lemon cream and floral finish'],
      'fresh-lemon-cupcakes-8': ['8 cupcakes', 'Fresh lemon cream', 'Floral decoration included'],
      'fresh-lemon-cupcakes-12': ['12 cupcakes', 'Best Value', 'Fresh lemon cream and floral finish'],
    },
    guideSteps: [
