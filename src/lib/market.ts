  ...
  AU: {
    ...
    products: {
      ...
      'fresh-lemon-cupcakes-6': {
        ...
        description: 'Made with freshly squeezed lemon juice and fresh lemon zest, from the cake batter to the lemon syrup and glaze. A bright, citrus-forward little cake finished with real lemon flavour in every step.',
        price: 36, priceNote: '6-piece box · lemon glaze and floral finish included',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-8': {
    ...
    productCardFeatures: {
      'pave-cake': ['Four layers of rich chocolate cake', 'Filled with smooth pave chocolate ganache', 'Dense, chocolate-forward finish'],
      ...
      'buttercream-cake': ['Signature Gâteau au Chocolat layers', 'Italian meringue, real butter and cocoa powder', 'Choose a cake colour'],
      'fresh-strawberry-vanilla-cream-cake': ['Fresh strawberries through the cake and on top', 'Vanilla fresh cream with real vanilla bean', 'Soft genoise cake layers'],
      'fresh-strawberry-chocolate-cream-cake': ['Fresh strawberries through the cake and on top', 'Chocolate fresh cream', 'Soft genoise cake layers'],
      ...
      'fresh-lemon-cupcakes-6': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 8, 12 or 16'],
