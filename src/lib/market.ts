  ...
  KR: {
    ...
    products: {
      ...
      'fresh-lemon-cupcakes-4': {
        ...
        price: 24000, priceNote: '4개 구성 · 레몬 글레이즈와 꽃 장식 포함',
      ...
      'fresh-lemon-cupcakes-8': {
        ...
        description: '신선한 레몬즙과 레몬 제스트를 사용하고 레몬 시럽, 생 레몬 글레이즈와 꽃 장식으로 마무리한 시드니 전용 상품입니다.',
        price: 45000, priceNote: '8개 구성 · 레몬 글레이즈와 꽃 장식 포함',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      ...
      'fresh-lemon-cupcakes-16': {
        ...
        description: '신선한 레몬즙과 레몬 제스트를 사용하고 레몬 시럽, 생 레몬 글레이즈와 꽃 장식으로 마무리한 시드니 전용 상품입니다.',
        price: 85000, priceNote: '16개 구성 · 레몬 글레이즈와 꽃 장식 포함',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
    },
    cakeSizeOptions: [
    ...
    productCardFeatures: {
      ...
      'vanilla-fresh-cream-cake': ['초콜릿 시트 4단', '바닐라 생크림', '사이즈 선택 가능'],
      ...
      'fresh-lemon-cupcakes-4': ['4개 구성', '신선한 레몬 제스트', '레몬 글레이즈와 꽃 장식 포함'],
      'fresh-lemon-cupcakes-6': ['6개 구성', '신선한 레몬 제스트', '레몬 글레이즈와 꽃 장식 포함'],
      'fresh-lemon-cupcakes-8': ['8개 구성', '신선한 레몬 제스트', '레몬 글레이즈와 꽃 장식 포함'],
      'fresh-lemon-cupcakes-12': ['12개 구성', 'Most Popular', '레몬 글레이즈와 꽃 장식 포함'],
      'fresh-lemon-cupcakes-16': ['16개 구성', '신선한 레몬 제스트', '레몬 글레이즈와 꽃 장식 포함'],
    },
    guideSteps: [
  ...
  AU: {
    ...
    products: {
      ...
      'cupcake-half-dozen': {
        ...
        description: 'Chocolate cupcakes with one finish across the whole box.',
        price: 30,
        priceNote: '6-piece box · from AUD 5.00 per cupcake',
        usesCacaoOptions: false,
        usesSizeOptions: false,
        usesChocolateTypeOptions: false,
        usesPoundAddonOptions: false,
      ...
      'cupcake-twenty-four': {
        id: 'cupcake-twenty-four',
        name: 'Chocolate Cupcakes',
        description: 'Chocolate cupcakes with one finish across the whole box.',
        price: 105,
        priceNote: '24-piece box · from AUD 4.38 per cupcake',
        usesCacaoOptions: false,
        usesSizeOptions: false,
        usesChocolateTypeOptions: false,
        usesPoundAddonOptions: false,
      ...
      'cupcake-forty-eight': {
        id: 'cupcake-forty-eight',
        name: 'Chocolate Cupcakes',
        description: 'Chocolate cupcakes with one finish across the whole box.',
        price: 195,
        priceNote: '48-piece box · from AUD 4.06 per cupcake',
        usesCacaoOptions: false,
        usesSizeOptions: false,
        usesChocolateTypeOptions: false,
        usesPoundAddonOptions: false,
      ...
      'choco-basque-cheesecake': {
        ...
        description: `A ${AU_CAKE_SIZE_LABELS['15cm']} chocolate Basque cheesecake with a deeply baked top and a smooth, rich centre.`,
        price: 55,
      ...
      'pave-choco-basque-cheesecake': {
        ...
        description: `Our ${AU_CAKE_SIZE_LABELS['15cm']} Chocolatier's Basque cheesecake finished with pave chocolate on top.`,
        price: 65,
        priceNote: AU_CAKE_SIZE_LABELS['15cm'],
        usesCacaoOptions: false,
        usesSizeOptions: false,
      ...
      'fresh-lemon-cupcakes-4': {
        ...
        price: 24, priceNote: '4-piece box · lemon glaze and floral finish included',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-6': {
        id: 'fresh-lemon-cupcakes-6', name: 'Lemon Cake · 6 pieces',
        description: 'Made with freshly squeezed lemon juice and fresh lemon zest, from the cake batter to the lemon syrup and glaze. A bright, citrus-forward little cake finished with real lemon flavour in every step.',
        price: 35, priceNote: '6-piece box · AUD 5.83 per cake',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-8': {
        id: 'fresh-lemon-cupcakes-8', name: 'Lemon Cake · 8 pieces',
        description: 'Made with freshly squeezed lemon juice and fresh lemon zest, from the cake batter to the lemon syrup and glaze. A bright, citrus-forward little cake finished with real lemon flavour in every step.',
        price: 45, priceNote: '8-piece box · lemon glaze and floral finish included',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-12': {
      ...
      'fresh-lemon-cupcakes-24': {
        id: 'fresh-lemon-cupcakes-24', name: 'Lemon Cake · 24 pieces',
        description: 'Made with freshly squeezed lemon juice and fresh lemon zest, from the cake batter to the lemon syrup and glaze. A bright, citrus-forward little cake finished with real lemon flavour in every step.',
        price: 120, priceNote: '24-piece box · AUD 5.00 per cake',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'fresh-lemon-cupcakes-48': {
        id: 'fresh-lemon-cupcakes-48', name: 'Lemon Cake · 48 pieces',
        description: 'Made with freshly squeezed lemon juice and fresh lemon zest, from the cake batter to the lemon syrup and glaze. A bright, citrus-forward little cake finished with real lemon flavour in every step.',
        price: 225, priceNote: '48-piece box · AUD 4.69 per cake',
        usesCacaoOptions: false, usesSizeOptions: false, usesChocolateTypeOptions: false, usesPoundAddonOptions: false, sizePrices: {},
      },
      'smore-stick': {
        id: 'smore-stick',
        ...
        price: 3.5,
        priceNote: '10, 25 or 50-stick sets · from AUD 2.70 per stick',
        usesCacaoOptions: false,
        usesSizeOptions: false,
        usesChocolateTypeOptions: false,
        usesPoundAddonOptions: false,
    ...
    cakeSizeOptions: [
      ...
      { value: '19cm', label: AU_CAKE_SIZE_LABELS['19cm'], description: 'A larger celebration size', price: 95 },
      { value: '22cm', label: AU_CAKE_SIZE_LABELS['22cm'], description: 'A generous party size', price: 115 },
    ],
    cacaoOptions: [
    ...
    productCardFeatures: {
      ...
      'cupcake-twenty-four': ['24 cupcakes', 'One finish for the whole box', 'Basic, Vanilla Fresh Cream, or Chocolate Buttercream'],
      'cupcake-forty-eight': ['48 cupcakes', 'One finish for the whole box', 'Basic, Vanilla Fresh Cream, or Chocolate Buttercream'],
      ...
      'fresh-lemon-cupcakes-4': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 12, 24 or 48'],
      'fresh-lemon-cupcakes-6': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 12, 24 or 48'],
      'fresh-lemon-cupcakes-8': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 12, 24 or 48'],
      'fresh-lemon-cupcakes-12': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 12, 24 or 48'],
      'fresh-lemon-cupcakes-16': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 12, 24 or 48'],
      'fresh-lemon-cupcakes-24': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 12, 24 or 48'],
      'fresh-lemon-cupcakes-48': ['Freshly squeezed lemon juice', 'Fresh lemon zest', 'Lemon syrup & glaze', 'Floral decoration', 'Boxes of 6, 12, 24 or 48'],
      'smore-stick': ['Toasted marshmallow on stick', 'Rich couverture chocolate coating', '10 sticks · AUD 35', '25 sticks · AUD 75', '50 sticks · AUD 135'],
    },
    guideSteps: [
