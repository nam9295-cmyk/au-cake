  ...
  en: {
    landing: {
      ...
      essentials: [
        ...
        { title: 'Limited Saturday classes', text: '26 September, 3 and 10 October 2026 with Jenny' },
      ...
      steps: [
        ...
        { title: 'Bring it to life', text: 'Build your chocolate cake with professional guidance from Jenny.' },
      ...
      confirmationNote: '* Booking is completed after availability and full payment are confirmed by Jenny.',
      ...
      finalCtaText: 'Limited Spring Saturday spots are handled manually so Jenny can confirm each class safely.',
    },
    reserve: {
      honeypot: 'Leave this field blank',
      backToClasses: 'Back to classes',
      title: 'Request a Kids Course',
      intro: 'Please fill out the details below. Jenny will confirm availability and send full payment details.',
      ...
      availabilityLoadError: 'Availability could not be loaded. Jenny will double-check this session before confirming.',
      ...
      paymentNote: 'Use this account after Jenny confirms the session is available.',
      submitting: 'Submitting...',
      selectedDateUnavailable: 'Date unavailable',
      submit: 'Request booking',
      submitNote: 'Jenny will confirm availability and send full payment details. Your booking is complete after payment is received.',
      errors: {
    ...
    complete: {
      ...
      availability: 'Jenny will check availability and confirm the session shortly.',
  ...
  ko: {
    landing: {
      ...
      essentials: [
        ...
        { title: '한정 토요일 클래스', text: 'Jenny와 함께하는 9월 26일, 10월 3일과 10일 수업입니다.' },
      ...
      steps: [
        ...
        { title: '직접 만들기', text: 'Jenny의 안내와 함께 초콜릿 케이크를 만듭니다.' },
      ...
      confirmationNote: '* Jenny가 가능 여부와 전체 결제를 확인한 뒤 예약이 확정됩니다.',
      ...
      finalCtaText: 'Jenny가 각 수업을 안전하게 확인할 수 있도록 봄방학 토요일 자리는 수동으로 안내합니다.',
    },
    reserve: {
      honeypot: '이 필드는 비워 두세요',
      backToClasses: '클래스 안내로 돌아가기',
      title: '키즈 클래스 예약 요청',
      intro: '아래 정보를 작성해 주세요. Jenny가 가능 여부를 확인한 뒤 전체 결제 정보를 안내합니다.',
      ...
      availabilityLoadError: '예약 가능 시간을 불러오지 못했습니다. Jenny가 확정 전 다시 확인합니다.',
      ...
      paymentNote: 'Jenny가 수업 가능 여부를 확인한 뒤 이 계좌로 안내해 드립니다.',
      submitting: '요청 보내는 중...',
      selectedDateUnavailable: '날짜 예약 마감',
      submit: '예약 요청 보내기',
      submitNote: 'Jenny가 가능 여부와 전체 결제 정보를 안내합니다. 결제가 완료된 뒤 예약이 확정됩니다.',
      errors: {
    ...
    complete: {
      ...
      availability: 'Jenny가 가능 여부를 확인한 뒤 곧 수업을 안내합니다.',
...
export function cakeCopy(language: Language) {
  if (language === 'ko') {
    return {
      ...
      koreanLabel: '한국어',
      languageHelp: '언어 선택',
      announcement: '케이크 픽업 · 금 18:00–20:00 · 토·일 08:00–20:00',
      ...
      pickupHours: ['케이크 픽업 · 금 18:00–20:00 · 토·일 08:00–20:00'],
      paymentLabel: '결제 정보',
      ...
      pickupDate: '픽업 날짜',
      pickupTime: '픽업 시간',
      pickupLeadTimeHelp: '케이크 픽업은 금요일 18:00–20:00, 토·일요일 08:00–20:00에 가능합니다. 전날 오후 8시 이후 주문 시 다음 날 낮 12시부터 선택할 수 있어요.',
  ...
  return {
    ...
    announcement: 'Cake pick-up · Fri 18:00–20:00 · Sat–Sun 08:00–20:00',
    ...
    pickupHours: ['Cake pick-up · Fri 18:00–20:00 · Sat–Sun 08:00–20:00'],
    ...
    pickupLeadTimeHelp: 'Cake pick-up is available Friday 18:00–20:00 and Saturday–Sunday 08:00–20:00. Orders placed after 8pm can be picked up from 12pm the next day.',
