...
export function cakeCopy(language: Language) {
  if (language === 'ko') {
    return {
      ...
      announcement: '최소 24시간 전 주문 · 다음날부터 픽업 가능',
      ...
      pickupHours: ['픽업 시간 매일 10:00-20:00'],
      paymentLabel: '결제 정보',
      ...
      pickupDate: '픽업 날짜',
      pickupTime: '픽업 시간',
      pickupLeadTimeHelp: '케이크는 미리 준비하므로 현재 시각에서 최소 24시간 이후 픽업만 선택할 수 있어요.',
      ...
      errors: {
        ...
        pickupDate: '현재 시각에서 최소 24시간 이후의 픽업 날짜를 선택해 주세요.',
        pickupTime: '픽업 시간을 선택해 주세요.',
        pickupTimeUnavailable: '선택한 시간이 방금 마감됐어요. 다른 픽업 시간을 선택해 주세요.',
        pickupLeadTime: '픽업 시간은 현재 시각에서 최소 24시간 이후로 선택해 주세요.',
  ...
  return {
    ...
    announcement: 'Order at least 24 hours ahead · Pick-up available from the next day',
    ...
    pickupLeadTimeHelp: 'Our cakes are prepared in advance. Please choose a pick-up time at least 24 hours from now.',
    ...
    errors: {
      ...
      pickupDate: 'Please select a pick-up date and time at least 24 hours from now.',
      ...
      pickupLeadTime: 'Please choose a pick-up time at least 24 hours from now.',
