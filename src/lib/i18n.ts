...
export function cakeCopy(language: Language) {
  if (language === 'ko') {
    return {
      ...
      announcement: '케이크 픽업 토·일 10:00–17:00',
      ...
      pickupHours: ['토·일 10:00–17:00 픽업'],
      paymentLabel: '결제 정보',
      ...
      pickupDate: '픽업 날짜',
      pickupTime: '픽업 시간',
      pickupLeadTimeHelp: '케이크 픽업은 토·일 10:00–17:00에 가능합니다. 전날 오후 8시 이후 주문 시 다음 날 낮 12시부터 선택할 수 있어요.',
  ...
  return {
    ...
    announcement: 'Cake pick-up Sat–Sun · 10:00–17:00',
    ...
    pickupHours: ['Saturday–Sunday pick-up · 10:00–17:00'],
    ...
    pickupLeadTimeHelp: 'Cake pick-up is available Saturday–Sunday, 10:00–17:00. Orders placed after 8pm can be picked up from 12pm the next day.',
