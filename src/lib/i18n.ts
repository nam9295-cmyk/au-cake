...
export function cakeCopy(language: Language) {
  if (language === 'ko') {
    return {
      ...
      pickupDate: '픽업 날짜',
      pickupTime: '픽업 시간',
      pickupLeadTimeHelp: '제작 준비를 위해 현재 시각에서 최소 2시간 뒤로 선택해 주세요.',
      ...
      errors: {
        ...
        pickupLeadTime: '픽업 시간은 현재 시각에서 최소 2시간 뒤로 선택해 주세요.',
  ...
  return {
    ...
    pickupLeadTimeHelp: 'Please choose a pick-up time at least 2 hours from now.',
    ...
    errors: {
      ...
      pickupLeadTime: 'Please choose a pick-up time at least 2 hours from now.',
