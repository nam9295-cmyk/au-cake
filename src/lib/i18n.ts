...
const koProducts: Partial<Record<ProductId, ProductText>> = {
  ...
  'fresh-lemon-cupcakes-24': {
    name: '레몬 케이크 · 24개', description: '생 레몬즙을 직접 짜고 신선한 레몬 제스트를 더해 케이크 반죽부터 레몬 시럽, 글레이즈까지 완성합니다. 레몬의 산뜻한 풍미를 단계마다 담아낸 작은 레몬 케이크입니다.', priceNote: '24개 구성',
  },
  'fresh-lemon-cupcakes-48': {
    name: '레몬 케이크 · 48개', description: '생 레몬즙을 직접 짜고 신선한 레몬 제스트를 더해 케이크 반죽부터 레몬 시럽, 글레이즈까지 완성합니다. 레몬의 산뜻한 풍미를 단계마다 담아낸 작은 레몬 케이크입니다.', priceNote: '48개 구성',
  },
  'smore-stick': {
    name: '스모어 스틱',
    description: '스틱에 꽂은 푹신한 마시멜로에 진한 커버춰 초콜릿을 더한 디저트. 모임과 파티용 대량 주문에 적합합니다.',
    priceNote: '10·25·50개 세트',
  },
}
  ...
  en: {
    landing: {
      ...
      essentials: [
        ...
        { title: 'Daily Spring classes', text: '26 September–12 October 2026, every day with our team' },
      ...
      finalCtaText: 'Spring class spots are handled manually so our team can confirm each class safely.',
    },
    reserve: {
      ...
      advancedDate: 'Advanced Date · 26 September–12 October',
      ...
      errors: {
        ...
        advancedDate: 'Please choose a date from 26 September to 12 October for the Advanced session.',
  ...
  ko: {
    landing: {
      ...
      essentials: [
        ...
        { title: '봄방학 매일 클래스', text: '베리굿 팀과 함께하는 9월 26일–10월 12일 매일 수업입니다.' },
      ...
      finalCtaText: '베리굿 팀이 각 수업을 안전하게 확인할 수 있도록 봄방학 클래스 자리는 수동으로 안내합니다.',
    },
    reserve: {
      ...
      advancedDate: '고급 수업 날짜 · 9월 26일–10월 12일',
      ...
      errors: {
        ...
        advancedDate: '고급 수업은 9월 26일–10월 12일을 선택해 주세요.',
